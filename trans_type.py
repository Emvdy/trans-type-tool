...
def parse_args(argv: list[str]) -> Options:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  simple 文本/text:\n"
            "    trans_type_py.exe --mode simple [--source clipboard|file|PATH]\n"
            "  cmd-hex 文本/text:\n"
            "    trans_type_py.exe --mode cmd-hex --source SOURCE [--remote-output TARGET]\n"
            "      [--output-encoding utf8|utf8-bom]\n"
            "  cmd-hex 单文件/raw file:\n"
            "    trans_type_py.exe --mode cmd-hex --source PATH --output-encoding preserve\n"
            "      [--remote-output TARGET]\n"
            "  zip-hex 文本/compressed text:\n"
            "    trans_type_py.exe --mode zip-hex --source SOURCE [--remote-output TARGET]\n"
            "      [--output-encoding utf8|utf8-bom]\n"
            "  zip-hex 单文件/raw file:\n"
            "    trans_type_py.exe --mode zip-hex --source PATH --output-encoding preserve\n"
            "      [--remote-output TARGET]\n"
            "  zip-hex 目录/folder:\n"
            "    trans_type_py.exe --mode zip-hex --source FOLDER [--remote-output TARGET]\n"
            "  只导出命令/export only:\n"
